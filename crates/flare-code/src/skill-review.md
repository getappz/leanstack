...
description: >
  ...
  /flare-review. Complements correctness-focused review, this one only
  hunts complexity (legacy: "ponytail-review" also works).
---
...
self-check is the flare-code minimum, not bloat, never flag it for deletion.
Does not apply the fixes, only lists them.
"stop flare-review" / "stop ponytail-review" or "normal mode": revert to verbose review style.
