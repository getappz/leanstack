...
Thank you for your interest in contributing to **agentflare** ("the Project"),
maintained by Shivakumar ("the Maintainer"). This Contributor License Agreement
...
then-current open-source license (the MIT License). The additional rights
granted to the Maintainer in Sections 2 and 3 exist **alongside**, and do not
diminish, that public license. The free and open-source distribution of agentflare
